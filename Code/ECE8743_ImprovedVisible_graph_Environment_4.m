...
start = [1,15];     % start position
goal = [15, 1];   % goal position
n = 2;             % no. of obstacles
...
rectangle('Position',[1 3 3 3], 'FaceColor',[0 .5 .5])
rectangle('Position',[2 8 2 8], 'FaceColor',[0 .5 .5])
rectangle('Position',[5 1 4 1], 'FaceColor',[0 .5 .5])
rectangle('Position',[7 6 2 4], 'FaceColor',[0 .5 .5])
rectangle('Position',[8 13 1 3], 'FaceColor',[0 .5 .5])
rectangle('Position',[11 0 2 9], 'FaceColor',[0 .5 .5])
rectangle('Position',[ 12 11  3 3], 'FaceColor',[0 .5 .5])
...
values = {start, [1 ,3] , [1,6], [4, 6], [4 ,3],[2 ,8],[2,16],[4 16],[4 ,8], [5 ,1] ,[5 ,2] ,[9 ,2] ,[9 ,1], [7 ,6] ,[7 ,10] ,[9 ,10] ,[9 ,6],[8 ,13] ,[8 ,16] ,[9 ,16] ,[9 ,13],[11 ,0] ,[11 ,9] ,[13 ,9] ,[13 ,0], [12 ,11] ,[12 ,14] ,[15 ,14] ,[15 ,11], goal};
%%%%%%%%%%%%%%%%%
